...
| CBOR-WEB-MULTIMEDIA.md | Rich images, video, audio, documents, diagrams, streaming | See §8.8 |
| CBOR-WEB-GENERATIVE.md | Templates, schemas, APIs, executables, workflows, forms, commerce | See §8.8 |
...
```cbor-diag
"generated_at": 1(1742515200)    ; 2026-03-21T00:00:00Z
"updated": 1(1742428800)         ; 2026-03-20T00:00:00Z
```
...
|-----------|-----------|------|
| 2026-01-01T00:00:00Z | 1767225600 | `C1 1A 694F5C00` |
| 2026-03-20T00:00:00Z | 1742428800 | `C1 1A 67DB5A80` |
| 2026-03-21T00:00:00Z | 1742515200 | `C1 1A 67DCAC00` |
| 2026-12-31T23:59:59Z | 1798761599 | `C1 1A 6B43F1FF` |
...
55799({                                ; self-described CBOR tag
  ...
  6: h'...',                           ; signature (OPTIONAL, see §5.7)
  7: { ... },                          ; capabilities (RECOMMENDED, see CBOR-WEB-GENERATIVE.md §17)
  8: [ ... ],                          ; channels (OPTIONAL, see CBOR-WEB-MULTIMEDIA.md §20)
  9: { ... },                          ; diff (OPTIONAL, see §10.5)
...
55799({                                ; self-described CBOR
  ...
  2: {                                 ; manifest (complete — same as §5, without 55799 tag)
    0: "cbor-web-manifest",
    1: 2,
    2: { "domain": "example.com", "name": "Example", ... },
    3: [ ... ],
    5: { ... }
  },
...
**CBOR diagnostic:**
```cbor-diag
{"t": "code", "lang": "python", "v": "def hello():\n    print('Hello, World!')"}
```
...
**CBOR diagnostic:**
```cbor-diag
{"t": "cta", "href": "/contact", "v": "Request a free quote"}
```
...
**CBOR diagnostic:**
```cbor-diag
{"t": "embed", "description": "Interactive map showing store locations in Europe", "src": "https://maps.google.com/embed?q=Verdetao"}
```
...
With severity:
```cbor-diag
{"t": "note", "level": "warn", "v": "Do not exceed the recommended daily dose."}
```
...
- Enforce size limits (§13 of CBOR-WEB-SECURITY.md)
...
- Include a `User-Agent` header identifying itself (§10.8, point 12 in corrections)
...
```cddl
; ══════════════════════════════════════════════════════════
; CBOR-Web Core Specification v2.1 — CDDL Schema
...
| `<a class="cta">`, `<button>` | `{"t": "cta", "href": "...", "v": "..."}` | Publisher decides what is a CTA |
...
*CBOR-Web Core Specification v2.1 — Document 1 of 6*
